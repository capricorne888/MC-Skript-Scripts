...
- **[Console]**: This simple script allow server owner to send colorful messages from the console.
...
I welcome contributions! If you have a Skript script you'd like to add or an improvement to suggest:
